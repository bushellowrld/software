 ...
 router.post('/addStu', (req, res) => {
   ...
   conn.query(sql, [params.student_num, params.student_name, params.school, params.major, params.ad_type,params.ad_method], function (err, result) {
     if (err) {
       console.log(err)
     }
     if (result) {
